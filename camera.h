...
namespace pr {
  ...
  public:
    ...
    inline  bool projectPoint(Eigen::Vector2f& image_point,
                              const Eigen::Vector3f& world_point,
                              Eigen::Isometry3f wtcp){
      image_point.setZero();
      Eigen::Vector3f camera_point;

      camera_point=wtcp.inverse(Eigen::Isometry)*world_point;
    ...
    int projectPoints(DictPoints points,
